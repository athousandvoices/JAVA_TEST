...
<body>
	...
	<section class="section">
		<br>
		<h1 style="margin-top:5px;">인사관리 사원 등록 화면</h1>
		<br>
		...
		<form name="f" method="post" action="insert_process.jsp" target="iframe1" onsubmit="return checkWrite();">
			<table border=1>
				...
				<tr>
					...
					<td width="350" height="35" align=left>
						<input type="text" name="id" size=30 id="id" class="textbox" maxlength=3 oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="350" height="35" align=left>
						<select name="phoneOne" style="width:50px; height:30px;">
						...
						-
						<input type="text" name="phoneTwo" size=7 maxlength=4 oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" style="width:70px; height:30px;">
						-
						<input type="text" name="phoneThree " size=7 maxlength=4 oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" style="width:70px; height:30px;">						
					</td>
				</tr>
				<tr>
					<td colspan="2" align=center height="30">
						<input type="submit" name="submit" value="등 &nbsp;록" class="buttons">
